...
func (n *NodeApi) GetXrpTransactions(c *gin.Context) {
	var res common.Response
	var tx request.GetXrpTransactions
	...
	global.NODE_LOG.Info("GetXrpTransactions: " + string(rd))

	result, err := service.NodeService.GetXrpTransactions(tx)
	if err != nil {
