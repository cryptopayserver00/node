...
func (n *NodeApi) GetOpTransactions(c *gin.Context) {
	var res common.Response
	var tx request.GetOpTransactions
	...
	global.NODE_LOG.Info("GetOpTransactions: " + string(rd))

	result, err := service.NodeService.GetOpTransactions(tx)
	if err != nil {
