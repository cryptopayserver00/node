...
func (n *NodeApi) GetPolTransactions(c *gin.Context) {
	var res common.Response
	var tx request.GetPolTransactions
	...
	global.NODE_LOG.Info("GetPolTransactions: " + string(rd))

	result, err := service.NodeService.GetPolTransactions(tx)
	if err != nil {
